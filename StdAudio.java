 ...
 *  <p>
 *  The audio format uses a sampling rate of 44,100 (CD quality audio), 24-bit, monaural.
 *
 *  <p>
...
public final class StdAudio {
    ...
    public static void play(double sample) {
        ...
        // convert to bytes
        short s = (short) (MAX_24_BIT * sample);
    ...
    public static double[] read(String filename) {
        ...
        for (int i = 0; i < n/2; i++) {
            d[i] = ((short) (((data[2*i+1] & 0xFF) << 8) + (data[2*i] & 0xFF))) / ((double) MAX_24_BIT);
        }
        return d;
    }
